...
# Melt the original df (with missing values)
df_long <- melt(df, varnames = c("User", "Book"), value.name = "Rating")

# Create Heatmap
ggplot(df_long, aes(x = Book, y = User, fill = Rating)) +
  geom_tile(color = "white") +
  scale_fill_gradient(low = "#f7fbff", high = "#08306b", na.value = "gray90") +
  labs(title = "User-Book Ratings Heatmap",
       x = "Books",
       y = "Users",
       fill = "Rating") +
  theme_minimal() +
